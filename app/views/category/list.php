            ...
            <?php else: ?>
                <?php foreach($categories as $category): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/project1/Category/edit/<?php echo $category->id; ?>" class="btn btn-warning btn-sm">Sửa</a>
                            <a href="/project1/Category/delete/<?php echo $category->id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này?');">Xóa</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
...
<a href="/project1/Product" class="btn btn-primary">Quay lại trang sản phẩm</a>
